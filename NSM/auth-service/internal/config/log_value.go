...
func (c Config) MarshalLogObject(enc zapcore.ObjectEncoder) error {
	...
	enc.AddString("redis.addr", c.Redis.Addr)
	enc.AddString("redis.password", redact(c.Redis.Password))
	...
	enc.AddBool("rate_limit.enabled", c.RateLimit.Enabled)
	enc.AddBool("rate_limit.fail_closed", c.RateLimit.FailClosed)
	enc.AddDuration("rate_limit.retry_after", c.RateLimit.RetryAfter)
	enc.AddInt64("rate_limit.login.ip_limit", c.RateLimit.Login.IPLimit)
	enc.AddInt64("rate_limit.login.account_limit", c.RateLimit.Login.AccountLimit)
	enc.AddInt64("rate_limit.login.pair_limit", c.RateLimit.Login.PairLimit)
	enc.AddDuration("rate_limit.login.block_duration", c.RateLimit.Login.BlockDuration)
